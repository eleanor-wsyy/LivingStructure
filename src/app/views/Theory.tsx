...
const properties = [
  ...
  { n: 5, tEn: "Positive Space", tZh: "正空间", 
    ...
    relZh: "通过塑造虚空增加 S（强度）。", 
    natureEn: "Nature avoids 'leftover' spaces; even the empty space between branches has a distinct shape.", 
    natureZh: "大自然避免“多余”的空间；即使是树枝间的空隙也有清晰的形状。", 
  ...
  { n: 6, tEn: "Good Shape", tZh: "良好形状",
    ...
    natureEn: "A water drop or a river stone, worn into an elemental and harmonious shape.", 
    natureZh: "水滴或河石，被磨成了基本且和谐的形状。", 
  ...
  { n: 7, tEn: "Local Symmetries", tZh: "局部对称", 
    ...
    natureEn: "Leaves, crystals, and animal faces possess striking local symmetry despite global variation.", 
    natureZh: "尽管整体有变化，树叶、水晶和动物面部都具有惊人的局部对称性。", 
  ...
  { n: 8, tEn: "Deep Interlock and Ambiguity", tZh: "深度交织与模糊性", 
    ...
    natureEn: "The jagged interlocking of continental plates or roots winding through rocks.", 
    natureZh: "大陆板块的锯齿状交错，或是盘绕穿过岩石的树根。", 
  ...
  { n: 9, tEn: "Contrast", tZh: "对比", 
    ...
    relZh: "通过阐明区别增加 S（强度）。", 
    natureEn: "The bright bloom of a flower against dark foliage, or stark shadows on a canyon wall.", 
    natureZh: "深色树叶衬托下明亮的花朵，或峡谷崖壁上鲜明的阴影。", 
  ...
  { n: 10, tEn: "Gradients", tZh: "渐变", 
    ...
    relZh: "通过连接尺度增加 H（层级）。", 
    natureEn: "The gradual thinning of a mountain atmosphere, or the color shift in a sunset.", 
    natureZh: "高山大气的逐渐稀薄，或是日落时的色彩过渡。", 
  ...
  { n: 11, tEn: "Roughness", tZh: "粗糙性", 
    ...
    relZh: "通过适应现实增加 S（强度）。", 
    natureEn: "Tree bark, mountain ridges, and coastlines derive their beauty from their unpolished, fractal roughness.", 
    natureZh: "树皮、山脊和海岸线的美源于它们未经打磨的分形粗糙感。", 
  ...
  { n: 12, tEn: "Echoes", tZh: "共鸣", 
    ...
    relZh: "通过自相似性增加 H（层级）。", 
    natureEn: "The branching of a river delta echoing the veins in a single leaf.", 
    natureZh: "河流三角洲的分支与单片树叶的叶脉形成呼应。", 
  ...
  { n: 13, tEn: "The Void", tZh: "虚空", 
    ...
    natureEn: "A clearing in a dense forest, or a perfectly still alpine lake.", 
    natureZh: "茂密森林中的林间空地，或是平静的高山湖泊。", 
  ...
  { n: 14, tEn: "Simplicity and Inner Calm", tZh: "简洁与内在平静", 
    ...
    relZh: "通过消除摩擦增加 S（强度）。", 
    natureEn: "A smooth expanse of untouched snow, or a clear blue sky.", 
    natureZh: "广阔无垠的纯洁雪原，或是清澈湛蓝的天空。", 
  ...
  { n: 15, tEn: "Not-Separateness", tZh: "非分离性", 
    ...
    natureEn: "A nest woven seamlessly into the branches of a tree.", 
    natureZh: "无缝编织在树枝间的鸟巢。", 
