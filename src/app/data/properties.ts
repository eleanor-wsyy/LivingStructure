export const properties = [
  ...
  {
    n: 3, tEn: "Thick Boundaries", tZh: "厚边界",
    quoteEn: "Thick boundaries create transitional layers that strengthen centers.",
    quoteZh: "厚边界通过过渡层强化中心。",
    mechEn: "Layered edges stabilize spatial continuity.",
    mechZh: "层级边界增强空间连续性。",
    relEn: "Increases S (Strength) by containing energy.",
    relZh: "通过包含能量增加 S（强度）。",
    natureEn: "Amazon oxbow lakes seen from below: each circular pool is enclosed by a dense ring of forest—a thick boundary as substantial as the water itself, giving each lake its identity as a strong center and tying it to the surrounding land.",
    natureZh: "从空中俯瞰亚马逊牛轭湖：每一个圆形水面都被浓密的森林环绕——这道厚边界与水体本身同等厚实，赋予每个湖泊强中心的身份，同时将它与周围陆地紧密相连。",
    exampleEn: "The left image shows the Gwalior Fort in India. The top-level railing acts as a thick boundary, highlighting the architectural facade as the center while harmonizing the relationship between the sky and the facade. The right image shows a 20th-century apartment building; due to a lack of thick boundaries, the architecture appears isolated from its surroundings. Thick boundaries exist not only on the exterior but also permeate through the various hierarchies within the center. In the Gwalior Fort, thick boundaries are incorporated across all scales—from railings and columns to wall surfaces. Internally, each thick boundary is composed of even smaller centers and thick boundaries, progressing hierarchically to achieve a rich and unified whole.",
    exampleZh: "左图为印度瓜廖尔城堡，顶层的围栏作为厚边界，凸显了建筑立面这一中心，同时协调了天空与立面的关系。右图为一座20世纪公寓，因缺乏厚边界，建筑显得孤立于周围环境。厚边界不仅存在于外部，也贯穿于中心内部的各个等级。在瓜廖尔城堡中，围栏、立柱、墙面等各尺度都包含厚边界，每个厚边界内部又由更小的中心 and 厚边界组成，层层递进，丰富统一。",
  ...
  },
  {
    ...
    mechEn: "The mechanism is the blurring of the outer thick boundary through interpenetration.",
    mechZh: "机制是通过相互渗透模糊外厚边界。",
